...
public class AppModelAOS extends AppModelBase {		private AdvantageShoppingApplication AdvantageShoppingApplication;
	
	public AppModelAOS(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AppModelAOS");
